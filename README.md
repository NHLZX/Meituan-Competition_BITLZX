...
仿真环境基于美团竞赛平台，我们仅提供了核心逻辑的完整代码供参考
持续更新中...
本项目是一个基于传统算法的视觉语言导航（Vision-Language Navigation）系统，专为地面移动机器人设计（为美团挑战赛构建），基于ROS平台进行算法开发任务，使用docker进行代码提交，算法提交到云端的仿真环境中运行，根据自己的脚本文件，任务结束后会返回bag文件记录话题数据供选手回放，其实调试的时间成本还是很大的，官方提供的部分文件在docs文件夹中，详细文件可见赛方官网。
